...
def main():
    ...
    poison_loader = torch.utils.data.DataLoader(
        poison_dataset, batch_size=args.batch_size, num_workers=0)
    ...
    for state in range(start_state, args.pruning_times):
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            test_tacc = validate(test_loader, model, criterion) #validate on ASR
            ...
            plt.plot(all_result['asr'], label='asr')
            plt.legend()
